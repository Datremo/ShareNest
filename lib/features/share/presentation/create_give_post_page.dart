...
class CreateGivePostPage extends StatefulWidget {
  const CreateGivePostPage({super.key});

  @override
  State<CreateGivePostPage> createState() => _CreateGivePostPageState();
}

class _CreateGivePostPageState extends State<CreateGivePostPage> {
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        border: Border.all(color: AppColors.give.withValues(alpha: 0.3), width: 2),
                        borderRadius: BorderRadius.circular(16),
                        color: AppColors.give.withValues(alpha: 0.05),
                      ),
                      child: const Center(
                        child: Icon(Icons.add_a_photo_rounded, color: AppColors.give, size: 32),
                      ),
                    ),
                  ),
                ],
          ...
          children: [
            ...
            Row(
              children: [
                ...
                IconButton(
                  onPressed: _addTag,
                  icon: const Icon(Icons.add_circle_rounded, color: AppColors.give, size: 32),
                ),
              ],
            ),
            if (_tags.isNotEmpty)
              Padding(
                ...
                child: Wrap(
                  ...
                  children: _tags.map((tag) => Chip(
                    ...
                    backgroundColor: AppColors.give.withValues(alpha: 0.1),
  ...
  Widget _buildSuccessStep() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 12),
        const Text(
          'Your item is now available for neighbors to pick up.',
          style: TextStyle(fontSize: 16, color: AppColors.textSecondary),
  ...
  InputDecoration _inputDecoration(String hint, {IconData? prefixIcon}) {
    return InputDecoration(
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(16),
        borderSide: const BorderSide(color: AppColors.give),
      ),
    );
  }
    ...
    return Expanded(
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: isSelected ? AppColors.give : Colors.white,
            border: Border.all(color: isSelected ? AppColors.give : AppColors.grey300),
