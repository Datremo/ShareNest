...
class EditExchangePostPage extends StatefulWidget {
  ...
  const EditExchangePostPage({super.key, required this.listing});

  @override
  State<EditExchangePostPage> createState() => _EditExchangePostPageState();
}

class _EditExchangePostPageState extends State<EditExchangePostPage> {
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        border: Border.all(color: AppColors.exchange.withValues(alpha: 0.3), width: 2),
                        borderRadius: BorderRadius.circular(16),
                        color: AppColors.exchange.withValues(alpha: 0.05),
                      ),
                      child: const Center(
                        child: Icon(Icons.add_a_photo_rounded, color: AppColors.exchange, size: 32),
                      ),
                    ),
                  ),
                ],
          ...
          children: [
                ...
                Expanded(
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.calendar_month_rounded, color: _availableImmediately ? Colors.grey : AppColors.exchange),
                          const SizedBox(width: 12),
                          Text(
                            _availableFrom != null
            ...
            Row(
              children: [
                ...
                IconButton(
                  onPressed: _addTag,
                  icon: const Icon(Icons.add_circle_rounded, color: AppColors.exchange, size: 32),
                ),
              ],
            ),
            if (_tags.isNotEmpty)
              Padding(
                ...
                child: Wrap(
                  ...
                  children: _tags.map((tag) => Chip(
                    ...
                    backgroundColor: AppColors.exchange.withValues(alpha: 0.1),
  ...
  InputDecoration _inputDecoration(String hint, {IconData? prefixIcon}) {
    return InputDecoration(
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(16),
        borderSide: const BorderSide(color: AppColors.exchange),
      ),
    );
  }
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: isSelected ? AppColors.exchange : AppColors.grey300),
