...
class _BorrowHubPageState extends State<BorrowHubPage> {
  ...
  late Stream<List<Listing>> _lendStream;

  @override
  void initState() {
    super.initState();
    _lendStream = _listingRepo.streamListingsByMode('LEND');
  }
  ...
  Future<void> _showFilters() async {
    final filters = await showModalBottomSheet<Map<String, dynamic>>(
      ...
      builder: (context) => BorrowFiltersBottomSheet(),
    );
    if (filters != null) {
      setState(() {
        ...
        child: GlassCard(
          ...
          child: TypeAheadField<Listing>(
                  ...
                  suffixIcon: Row(
                    ...
                    children: [
                      IconButton(
                        ...
                        onPressed: () {
                          context.push('/search_results?mode=LEND&query=${controller.text}');
                        }
                      ),
                      GestureDetector(
                        onTap: _showFilters,
            ...
            suggestionsCallback: (pattern) async {
              ...
              return await _listingRepo.searchListings(pattern, mode: 'LEND');
            },
